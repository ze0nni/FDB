...
{
    public class ChooseRefWindow_BAK<TNestLevel> : PopupWindowContent
    {
        ...
        public static Ref Field(
            ...
            {
                _controlId = id;
                PopupWindow.Show(_hoveredRect, new ChooseRefWindow_BAK<TNestLevel>(resolver, modelType, currentField, width));
            }
        ...
        private ChooseRefWindow_BAK(DBResolver resolver, Type modelType, Ref currentField, float width)
        {
            _resolver = resolver;
